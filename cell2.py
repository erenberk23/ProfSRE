...
pandas2ri.activate()
wd = "C:/Users/eren.aytac/OneDrive - Roof Stacks Yazılım Anonim Şirketi/Masaüstü/Cell2Cell"
...
def SRE(traindata, termmodel=False, valdata=None, rules_nrtrees=10, regular_type=["stepwisereg","lasso","ridge","elasticnet","SSVS","caret.optimized","SGL"],
    ...
    if regular_type not in ["SSVS", "caret.optimized", "SGL", "SGL2","lasso2"]:
        ...
        if(add_stability):
            ...
            robjects.globalenv['s_index'] = 1
            robjects.globalenv['e_index'] = e_index
            robjects.globalenv['eta_stability'] = 0.5
...
traindata = pd.read_csv(f'{wd}/Data/aer_train.csv')
testdata = pd.read_csv(f'{wd}/Data/aer_test.csv')
...
joblib.dump(termmod, wd + "/Models/AerExp.pickle")

model = joblib.load(wd+ "/Models/AerExp.pickle")
...
joblib.dump(sremod2, wd + "/Models/denemeAerExpSRE.pickle")


sremod2 = joblib.load(wd+ "/Models/denemeAerExpSRE.pickle")
